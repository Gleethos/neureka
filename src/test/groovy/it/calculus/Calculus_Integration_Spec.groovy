...
class Calculus_Integration_Spec extends Specification
{
    ...
    def 'Tensor results of various Function instances return expected results.'(
        ...
        where :
            ...
            "softsign(i0*i1)"                | [Tsr.of([2],[1d, 2d]), Tsr.of([2],[3d, -4d])]                    | null  || [[2]:[0.75, -0.8888888888888888]]
            "softsign(i0*i1)"                | [Tsr.of([2],[1d, 2d]), Tsr.of([2],[3d, -4d])]                    | 0     || [[2]:[0.1875, -0.04938271604938271]]
            "fast_gaus(i0/i1)"               | [Tsr.of([2],[1d, 2d]), Tsr.of([2],[3d, -4d])]                    | null  || [[2]:[0.8999999999999999, 0.8]]
            "fast_gaus(i0/i1)"               | [Tsr.of([2],[1d, 2d]), Tsr.of([2],[3d, -4d])]                    | 0     || [[2]:[-0.18, -0.16]]
