...
class Cross_Device_Spec extends Specification
{
    ...
    def 'Mapping tensors works for every device (even if they are not used).'(
        ...
        where : 'We use the following data to test this mapping for a wide range of types and values!'
            ...
            Tsr.ofFloats().scalar(0.5f)| Device.get('first')  | Integer.class  | {it*10}  || '(1):[5.0]'
            Tsr.ofFloats().scalar(0.7f)| Device.get('first')  | Long.class     | {it*5}   || '(1):[3.0]'
            Tsr.ofFloats().scalar(0.9f)| Device.get('first')  | Byte.class     | {it*2}   || '(1):[1.0]'
            Tsr.ofFloats().scalar(3.8f)| Device.get('first')  | Short.class    | {it/2}   || '(1):[1.0]'
            ...
            Tsr.ofShorts().scalar( 5 ) | Device.get('first')  | Integer.class  | {it*10}  || '(1):[50.0]'
            Tsr.ofShorts().scalar( 70) | Device.get('first')  | Long.class     | {it*5}   || '(1):[350.0]'
            Tsr.ofShorts().scalar( 90) | Device.get('first')  | Byte.class     | {it*2}   || '(1):[-76.0]'
            Tsr.ofShorts().scalar( 37) | Device.get('first')  | Short.class    | {it/2}   || '(1):[18.0]'
            ...
            Tsr.ofBytes().scalar( 5 )  | Device.get('first') | Integer.class  | {it*10}  || '(1):[50.0]'
            Tsr.ofBytes().scalar( 70)  | Device.get('first') | Long.class     | {it*5}   || '(1):[350.0]'
            Tsr.ofBytes().scalar( 90)  | Device.get('first') | Byte.class     | {it*2}   || '(1):[-76.0]'
            Tsr.ofBytes().scalar( 37)  | Device.get('first') | Short.class    | {it/2}   || '(1):[18.0]'
