...
class Calculus_Implementation_Unit_Tests extends Specification
{
    ...
    def 'Activation implementations behave as expected.'(
        ...
        where : 'The variable "imp" is from a List of OperationType implementations of activation types.'
            imp << OperationContext.instance()
                .instances()
                .stream()
                .filter(
    ...
    def 'Convolution implementations behave as expected.'(
        ...
        where : 'The variable "imp" is from a List of OperationType implementations of convolution types.'
            imp << OperationContext.instance()
                .instances()
                .stream()
                .filter(
