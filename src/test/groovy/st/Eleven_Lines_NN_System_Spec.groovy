...
class Eleven_Lines_NN_System_Spec extends Specification {
    ...
    private static var RESULT_W1_F32 = [-0.91154915, -2.8053198, -0.25180113, -1.3116924, -0.6594294, 2.512382, -1.0514474, -1.2928098, 1.3971564, 2.2039096, -0.6782811, 2.738544]
    private static var RESULT_W2_F32 = [0.13907683, -1.8305545, -0.74910396, 1.8749583]
    ...
    def 'One can write a simple float based neural network in less than 11 lines of java like code!'()
    {
        ...
        expect :
            W1.data == RESULT_W1_F32 as float[]
            W2.data == RESULT_W2_F32 as float[]
    }
