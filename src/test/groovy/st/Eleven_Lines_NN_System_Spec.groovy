...
class Eleven_Lines_NN_System_Spec extends Specification {
    ...
    def 'One can write a simple neural network with custom back-prop in 11 lines of code!'()
    {
        ...
        expect :
            W1.unsafe.data == RESULT_W1
            W2.unsafe.data == RESULT_W2
    }
    ...
    def 'One can write a simple float based neural network in less than 11 lines of java like code!'()
    {
        ...
        expect :
            W1.unsafe.data == RESULT_W1_F32 as float[]
            W2.unsafe.data == RESULT_W2_F32 as float[]
    }
    ...
    def 'The pseudo random number generator works as expected for the weights used in the 11 line NN examples!'()
    {
        ...
        expect :
            W1.unsafe.data == [-0.910969595136708, -1.9627469837128895, -0.048245881734580415, -0.3554745831321771, -0.6595188311162824, 1.839723209668042, -0.7864999508162774, -1.918339420402628, 1.4035229760225527, 2.245738695936844, -0.7473176166694635, 1.9016692137691462]
            W2.unsafe.data == [-0.1611330910958405, -0.9350019667613545, -0.3780200880067806, 1.4951759768158595]
    }
