...
public class BroadSystemTest
{
    ...
    public static boolean on()
    {
        ...
        tensor3 = Tsr.of(2);
        try {
            Function.Setup.commit( new Tsr[]{tensor1, tensor2, tensor3}, Function.of("(Ig[0]<-I[1])->I[2]", true));
        } catch ( Exception e ) {
            tester.testContains(
        ...
        Tsr<Double> result = Function.Setup.commit( new Tsr[]{tensor1, tensor2, tensor3}, Function.of("(Ig[0]<-I[1])->I[2]", false));
        tester.testContains(
                result.toString(),
                new String[]{"(-4.0)"},
        ...
        result = Function.Setup.commit( new Tsr[]{tensor1, tensor2, tensor3}, Function.of("i0<<xi1<<xi2", true));
        tester.testContains(
                result.toString(),
        ...
        result = Function.Setup.commit( new Tsr[]{tensor1, tensor2, tensor3}, Function.of("i2x>>i1x>>i0", true));
        tester.testContains(
                result.toString(),
                new String[]{"[2x3]:(-26.0, 10.0, 32.0, 15.0, 34.0, 3.0)"},
                "Testing if Function.setup.commit() returns non unique result!"
