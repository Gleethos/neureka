...
public class NVTesting_Activation extends NVTesting{
	...
	public int testNode_ScalarActivation(NVertex core, double[] input, double expected) 
	{
		...
		if(assertEqual(a, expected)==false){
			success=false;
		}
		Console.println(bar+"----------------------------------------------------");
	...
	{
		this.performForwardBackwardOn(Structure);
		boolean success = true;
		Console.println("");
		...
		Console.println(bar+"====================================================");
		Console.println(bar+"");
		Console.println(bar+"  Value Derivatives: ");
		Console.print(bar+" ");
	...
	public int testGraph_RelationalDeriviation(NVertex[] Structure, NVertex head, double[] expectedInput, double[][] expectedRelational)
	{
		...
		//-----------------------------------------------------------------------
		Console.println(bar+"");
		Console.println(bar+"  Activation Test: ");
		Console.print(bar+" ");
		double[] a = {head.getActivation(0)};
		if(!this.assertEqual(stringified(a), stringified(expectedInput))){
			success = false;
		}
		//-----------------------------------------------------------------------
		Console.println(bar+"====================================================");
		...
		Console.print(bar+" ");
		double[][] b = head.getRelationalDerivative();
		if(!this.assertEqual(stringified(b), stringified(expectedRelational))){
			success = false;
		}
		//-----------------------------------------------------------------------
		Console.println(bar+"====================================================\n");
