package neureka.main.core.modul.mem;
...
public class NVMemory {
	...
	//	for(int i=dInputHistory.size()-Hi; i<dInputHistory.size(); i++) {newMemorized.e_add(dInputHistory.e_get(i));}
	...
	//{
	//	ArrayList<double[][]> newMemorized = new ArrayList<double[][]>();
	//	for(int i=activationHistory.size()-Hi; i<activationHistory.size(); i++) {newMemorized.e_add(activationHistory.e_get(i));}
