...
public class TKernel extends Kernel
{
    ...
    public int[] translations(){
        this.get(this.translations);//probably obsolete
    ...
    * */
    ...
    public int calculate_tsr(int[] mode){
    ...
    public void run() {
        ...
        if(mde[0]==18){//  tsr_mul
            run_tsr_prd(gid, mde[1], mde[2], mde[3]);
        }
    ...
    public void run_tsr_gus(int gid, int drn_id, int src_id, int d){
        ...
        //}
        //for(int i=0; i<tmp_idx.length; i++){
        //    this.values[gid] = (this.tmp_idx[gid%tmp_idx.length])*(gid)*10;
        //}
        ...
        //this.values[tsr_ptr(drn_id)+__i_of(gid, drn_id, 0)] = 9999;
        //this.values[gid] = tsr_ptr(drn_id)+__i_of(gid, drn_id, 0);
        //this.tmp_idx[gid%tmp_idx.length]=0;
    }
    ...
    public void run_tsr_prd(int gid, int drn_id, int src1_id, int src2_id){
