...
public class NThreadPool implements Runnable {
    ...
    public void setBackward(BigInteger backward) {
        this.BackwardScope = backward;
    }

    public void setForwrad(BigInteger forward) {
        this.ForwardScope = forward;
    }
    ...
    private void startForwardThreading() {
        ...
        while (iterator.hasNext()) {
            ...
            current.getExecutable().loadLatest();
        }
    ...
    private void startBackwardThreading()//true false - threading or not!
    {
        ...
        while (iterator.hasNext()) {
            ...
            current.getExecutable().loadTrainableState(Counter);
        }
