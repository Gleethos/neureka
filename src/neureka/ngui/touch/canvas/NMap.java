...
public class NMap extends NMap_I {
	...
	@Override
	public synchronized void paintStructure(GraphicsContext brush) {

		Font F = new Font("Tahoma-PLAIN", (double)(size*(0.1)));
		Color C = null;//brush.getFill()..getColor();
		...
		brush.setStroke(B);
		brush.fillText(TLNode.getCount()+"", (int)(X-1600), (int)(Y-1200));
		}
		if(TRNode!=null) {
		brush.setStroke(C);
		TRNode.paintStructure(brush);brush.fillOval((int)(X     ), (int)(Y-2000), 2000, 2000);
		brush.setStroke(B);
		brush.fillText(TRNode.getCount()+"", (int)(X+1000 ), (int)(Y-1200));
		}
		if(BLNode!=null) {
		brush.setStroke(C);
		BLNode.paintStructure(brush);brush.fillOval((int)(X-2000), (int)(Y     ), 2000, 2000);
		brush.setStroke(B);
		brush.fillText(BLNode.getCount()+"", (int)(X-1600), (int)(Y+1200 ));
		}
		if(BRNode!=null) {
		brush.setStroke(C);
		BRNode.paintStructure(brush);brush.fillOval((int)(X     ), (int)(Y     ), 2000, 2000);
		brush.setStroke(B);
		brush.fillText(BRNode.getCount()+"", (int)(X+1000 ), (int)(Y+1200));
		}
		if(Elements!=null)
		{
		...
		brush.setStroke(B);
		brush.fillText(this.getCount()+"", (int)(X-300), (int)(Y-50));
		brush.setStroke(C);
		}
		brush.setStroke(Color.GREEN);
	...
	public class Leave extends NMap_I {
		...
		public synchronized void paintStructure(GraphicsContext brush)
		{
			...
			Elements.forEach((k, v) ->
			{
				brush.fillOval((int)(v.getX()-500), (int)(v.getY()-500), 1000, 1000);
				brush.fillOval((int)(v.getX()-700), (int)(v.getY()-700), 1400, 1400);
				brush.fillOval((int)(v.getX()-1000), (int)(v.getY()-1000), 2000, 2000);
				brush.fillOval((int)(v.getX()-2000), (int)(v.getY()-2000), 4000, 4000);
			});
		}
		//==============================================================================
		@Override
