...
public class NVTesting_Format {
	...
	public int inputSizeTest(NVertex core, int expectedSize) 
	{
		...
		{
			Console.println(bar+"  ");
			Console.println(bar+"  Input Size Test ('Vi':"+Vi+" of "+core.size()+"): "+core.getFunction().expression());
			Console.println(bar+"====================================================");
			Console.print(bar+"  Input size: "+core.inputSize()+"; Expected: "+expectedSize+"");
			...
			Console.println(bar+"  Input array:           "+core.getInput()[Vi].length+message);
			//----------------------------------------------------------------------------
