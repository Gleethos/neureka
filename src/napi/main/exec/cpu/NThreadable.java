...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	...
	{Executable=executable;  ID=threadID; isBackpropagating=backProp;} 
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	public void run()
	{
	...
	public void    setIsBackpropagating(boolean value) {isBackpropagating=value;}

	public boolean isBackpropagating() {return isBackpropagating;}
	
	public NVExecutable getExecutable() {return Executable;}
