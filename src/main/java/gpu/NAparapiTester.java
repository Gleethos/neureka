...
public class NAparapiTester  
{
    ...
    public static void testConvector() {
    	...
    	Range range = device.createRange(gs);
        ...
        {//===================================================
            ...
            ConvectorKernel.put(ConvectorKernel.getB()); //Fetching data from GPU to main memory!
            ConvectorKernel.put(ConvectorKernel.getC());
            ConvectorKernel.put(ConvectorKernel.getA());
        	long  time1 = System.currentTimeMillis();
        	
        	for(int i=0; i<2500; i++) {}//ap.setA(new float [com *    r]);
