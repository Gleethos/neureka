...
public interface Fun
{
    ...
    interface ObjObjToObj extends Fun
    {
        ...
        static FunTuple<ObjObjToObj> triple(
            ...
            return new BiElementWise.FunTriple<>( activation, derivation, derivation2 );
        }

        static FunTuple<ObjObjToObj> of(ObjObjToObj activation ) {
            return new BiElementWise.FunTriple<>( activation, null, null );
        }
    }
    ...
    interface F64F64ToF64 extends Fun
    {
        ...
        static FunTuple<F64F64ToF64> triple(
            ...
            return new BiElementWise.FunTriple<>(activation, derivation1, derivation2);
        }
