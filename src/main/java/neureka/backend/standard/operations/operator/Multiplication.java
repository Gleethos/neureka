                    ...
                    .andImplementation(
                        call -> {
                            if ( call.getDerivativeIndex() == 0 )
                                call.getTensors()[0] = call.getTensors()[2].shallowCopy().getMutate().setIsIntermediate( true );
                            else if ( call.getDerivativeIndex() == 1 )
                                call.getTensors()[0] = call.getTensors()[1].shallowCopy().getMutate().setIsIntermediate( true );
                            else
