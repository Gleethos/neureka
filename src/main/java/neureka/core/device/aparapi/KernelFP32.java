...
public class KernelFP32 extends AbstractKernel
{
    /**   +============================+
     *    || DEFINING FP - TYPE (64): ||
     *    +============================+
     ...
     *    =======================
     * */
    protected float[] __val;

    @Override
    public double[] value(){
        this.get(__val); 
        double[] value = new double[__val.length];
        for(int i=0; i<__val.length; i++){
            value[i] = __val[i];
        }
        return value; 
    }
    ...
    protected void _put_new_val(double[] newVal){
        //__val = newVal;
        __val = new float[newVal.length];
        for(int i=0; i<newVal.length; i++){
            __val[i] = (float)newVal[i];
        }
        this.put(__val);
    }
    ...
    protected void _run_relu(int gid){
        if (__d()<0) {
            if (_values[__i(gid, 2)] >= 0) {
                ...
                _values[__i(gid, 1)] = (_values[__i(gid, 2)]) * 0.01f;
            }
        } else {
            if (_values[__i(gid, 2)] >= 0) {
                _values[__i(gid, 1)] = 0.01f;
            } else {
                _values[__i(gid, 1)] = 0.01f;
            }
        }
    ...
    protected void _run_sig(int gid){
        if(__d()<0){
            _values[__i(gid, 1)] =
                    1 / (1 + (float) Math.pow(Math.E, (-_values[__i(gid, 2)])));
    ...
    protected void _run_qdr(int gid){
        if(__d()<0){
            _values[__i(gid, 1)] =
                    (float) Math.pow(_values[__i(gid, 2)],2);
        }else{
            _values[__i(gid, 1)] =
                    _values[__i(gid, 2)]*2;
        }
    ...
    protected void _run_lig(int gid){
        if(__d()<0){
            _values[__i(gid, 1)] = (
                    (float) Math.log(1+Math.pow(Math.E, _values[__i(gid, 2)]))
            );
        }else{
            _values[__i(gid, 1)] =
                    1 /
    ...
    protected void _run_gus(int gid){
        if(__d()<0){
            _values[__i(gid, 1)] =
                    (float) Math.pow(Math.E, -Math.pow(_values[__i(gid, 2)], 2));
        }else{
            _values[__i(gid, 1)] =
                    -2 * (_values[__i(gid, 2)])
                            * (float) Math.pow(Math.E, -Math.pow(_values[__i(gid, 2)], 2));
    ...
    protected void _run_sin(int gid){
        _values[__i(gid, 1)] =
                (float) Math.sin(_values[__i(gid, 2)]);
    }

    @Override
    protected void _run_cos(int gid){
        _values[__i(gid, 1)] =
                (float) Math.cos(_values[__i(gid, 2)]);
    }
    ...
    protected void _run_pow(int gid){
        if (__d() < 0) {
            _values[__i(gid, 1)] = _values[__i(gid, 2)];
            for (int i = 2; i < __n(); i++) {
                _values[__i(gid, 1)] = (float) Math.pow(_values[__i(gid, 1)], _values[__i(gid, 1+i)]);
            }
            /**Note:
    ...
    protected void _run_broadcast_pow(int gid){
        _values[__i(gid, 1)] =
                (float) Math.pow(_values[__i(gid, 1)], __val[0]);
    }
    ...
    protected void _run_div(int gid){
        ...
        if (__d() < 0) {
            ...
            _values[__i(gid, 1)] = result * -(float) Math.pow(temp, -2);
        }
