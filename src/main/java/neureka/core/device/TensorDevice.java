...
public class TensorDevice {
    ...
    public TensorDevice(String name)
    {
        if (name == null) {
            _device = null;
            _kernel = null;
            ...
            System.out.println("TensorDevice of new kernel:\n------------");
        ...
        //.asList(new TensorDevice[] {your_device_here)})
        //dl.add(_device);
    ...
    public TensorDevice overwrite(Tsr drain, Tsr source)
    {
        _execute(new Tsr[]{drain, source}, IFunction.TYPES.LOOKUP.get("idy"), -1);
        return this;
    }

    public TensorDevice overwrite(Tsr tensor, double[] value)
    {
    ...
    public TensorDevice add(Tsr tensor) {
