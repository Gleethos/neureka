...
/**
 *  This interface defines the functionality of the component of a simple
 *  component system used by Neureka.
 *  Currently the only implemented component system using this interface
 *  is that of the Tsr class.
 *  Meaning that said class is the "owner" of components
 *  as is defined by the type parameter below.
 *
