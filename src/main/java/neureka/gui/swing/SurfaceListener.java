...
public class SurfaceListener implements MouseListener, MouseMotionListener, MouseWheelListener
{
    ...
    neureka.gui.swing.Surface Surface;

    SurfaceListener(neureka.gui.swing.Surface surface) {
        Surface = surface;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (clickedX == e.getX() && clickedY == e.getY()) {
            ...
            Surface.clickedAt(e.getX(), e.getY());
            collapseDragVector();
        }
        clickedX = e.getX();
        clickedY = e.getY();
