...
public class NPanelNode implements NPanelObject
{
	...
	NPanelNode(double x, double y, int ID) 
	{
		...
		Core = new T();
		Core.add(this);
		//Core.inject(new NVOptimizer(Core.size(), Core.getConnection(), 3));
	...
	{//System.out.println("convection: "+convection);
		...
		//								 //WEIGHT REPAINT:
		//								 queue.inject(new NPanelRepaintSpace((midPX),(midPY), 50, 25));
		//							 	}
		...
		//						     queue.inject(new NPanelRepaintSpace(
		//								repaintCenterX,
		//								repaintCenterY,
		//								distanceX,
		//								distanceY));
		...
		//				    		queue.inject(InputNode.get(Ii).getRepaintSpace(diameter/2));
