package neureka.internal.fluent.building.states;
 ...
 *  methods {@link IterByOrIterFromOrAll#iterativelyFilledFrom(Object)}, {@link To#to(Object)}
...
public interface Step<V>
{
     ...
     *  been passed to {@link IterByOrIterFromOrAll#iterativelyFilledFrom(Object)}
