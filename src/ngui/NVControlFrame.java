...
public class NVControlFrame extends JFrame implements ActionListener, KeyListener, ItemListener, MouseListener, MouseWheelListener {
            	       ...
            	       JPanel VariableAccessSubPanel = new JPanel();
            	           VariableAccessSubPanel.setLayout(new BorderLayout());
            	 		   ...
            	 		   inputIndexingField = new JTextField();	
            	 			   inputIndexingField.setText("Input Index");	
            	 			...
            	 			///////////////////////////////////////////////////////////
            	 			   	...
            	 			   	JPanel indexingSubPanel = new JPanel();
            	 	     	        ...
            	 	     	        indexingSubPanel.setBorder(BorderFactory.createEmptyBorder(0, 3, 0, 0));
            	 			   		//indexingSubPanel.add(shiftIndexingField, BorderLayout.CENTER);
            	 			   		//indexingSubPanel.add(weightIndexingField, BorderLayout.SOUTH);	 
            	 			   	...
            	 			   	JPanel valueSubPanel = new JPanel();
            	 			   		...
            	 			   		//valueSubPanel.add(shiftModField, BorderLayout.CENTER);
            	 			   		//valueSubPanel.add(weightModField, BorderLayout.SOUTH);
            	 			   	...
            	 			   	JLabel variableAccessLabel = new JLabel("  Variable access and modification:  ",JLabel.CENTER);
            	 			   		...
            	 			   		VariableAccessPanel.add(weightControlLabel, BorderLayout.NORTH);
            	 			   			...
            	 			   			//	VariableActionButtonPanel.add(VariableUpdateButton, cons);
            	 			   		    //	VariableActionButtonPanel.add(VariableResetButton, cons);
            	 			   			  //  VariableActionButtonPanel.add(VariableUpdateButton, BorderLayout.NORTH);
                	 			   			//VariableActionButtonPanel.add(VariableResetButton, BorderLayout.SOUTH);
            	 			   ...
            	 			   //=============================================================================================
            	 			    ...
            	 			    "Input root node","Super root node"		
            	 			    };
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == VariableUpdateButton) {System.out.println("Input mod update button pressed!");
        if(isInteger(historyIndexingField.getText())) {// double
        	try
        	{
        	    int newIndex = Integer.parseInt(historyIndexingField.getText());
	...
	public void mouseWheelMoved(MouseWheelEvent e) {
		...
		if(inputIndexingFieldEntered) {
		    ...
		    if(isInteger(inputIndexingField.getText())) 
			   ...
			   {
			    	System.out.println("Input index mod not acceptable!");
		...
		if(historyIndexingFieldEntered) {
		    ...
		    if(isInteger(historyIndexingField.getText())) 
			   ...
			   {
			    	System.out.println("Input index not acceptable!");
		...
		if(inputFieldEntered) {
		    ...
		    if(isInteger(inputModField.getText())) 
		       { int newValue = parseInteger(inputModField.getText()); System.out.println("New input: "+newValue);
		         newValue+=e.getWheelRotation();
		         inputModField.setText("Input: "+newValue);
		       }
			    else
			   {System.out.println("Input mod not acceptable!");
