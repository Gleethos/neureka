...
<p align="center">OpenCL accelerated nd-arrays / tensors for Java, Kotlin, Groovy, Scala, Jython, JRuby...</p>
 ...
 <!---
  ...
  - Try out the latest release: [neureka.jar](https://github.com/Gleethos/neureka/raw/master/production/lib/neureka-0.12.0.jar)
 -->
...
```
dependencies {
	implementation 'com.github.Gleethos:neureka:v0.12.0'
}
```
...
@Grab('com.github.Gleethos:neureka:v0.12.0')
